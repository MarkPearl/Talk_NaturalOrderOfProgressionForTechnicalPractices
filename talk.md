...
So how do you create slack? One way is to invest in practices that are easy to adopt and quick to apply. These practices may not necessarily be the most valuable in the long run. They can however be good choices to help create initial slack which will help you create the capacity to embark on the harder and sometimes more beneficial practices. The pattern I like to use is as follows, Learn a new practice, as the practice starts to realize a return you will save some time. That time you have created you can re-invest in creating additional slack to lern the harder practices. And then you rinse and repeat.
